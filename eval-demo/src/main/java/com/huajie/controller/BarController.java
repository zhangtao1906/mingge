...
import com.huajie.service.impl.echarts.TeamMajorCompareBar;
...
public class BarController extends BaseController {
     ...
     * 展示各站在某一天对应的专业
     */
    @PostMapping("/teamMajorCompareBar")
    @ResponseBody
    public ResponseBase teamMajorCompareBar(HttpServletRequest request) {
        Map<String, Object> conditionMap = QueryUtils.getParams(request);
        AbstractBarStack barStack = echartsFactory.createBarStack(conditionMap, TeamMajorCompareBar.class);
